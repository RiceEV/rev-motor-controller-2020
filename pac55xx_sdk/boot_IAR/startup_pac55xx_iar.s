...
Reset_Handler:
        ...
        ; Call pac_recovery function to allow recovery of misconfigured device
        LDR     R0, =pac_recovery
        BLX     R0

        ; Call IAR Program Initialization
...
pac_delay_asm:
        ...
        movs r1, #1
delay_loop1:
        subs  r0,r0,r1       ; Decrement r0=counts by r1=decrement value
        cmp r0, #0
...
;=============================================================================
; @brief  This function implements a delay in assembly to provide a consistent
;         delay independent of compiler optimizations.  This version is
;         executed as a ramfunc in RAM, and is useful for Flash operations that
;         must be executed from RAM and require a delay
; @param  counts - number of loop iterations
; @retval None
;============================================================================= 
        ...
        THUMB
        PUBLIC pac_delay_asm_ramfunc
pac_delay_asm_ramfunc:
        push {r1}
        movs r1, #1
delay_loop2:
        subs  r0,r0,r1       ; Decrement r0=counts by r1=decrement value
        cmp r0, #0
        bne delay_loop2      ; Keep looping until counts == 0
        pop {r1}
        bx  lr
