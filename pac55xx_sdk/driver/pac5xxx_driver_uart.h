 ...
 *
 */
RAMFUNC_UART static inline int pac5xxx_uart_interrupt_identification2(PAC55XX_UART_TYPEDEF* uart_ptr) { return uart_ptr->IIR.INTID; }
 ...
 */
RAMFUNC_UART static inline uint8_t pac5xxx_uart_read2(PAC55XX_UART_TYPEDEF* uart_ptr) { return (uint8_t) (uart_ptr->RBR.RBR); }
 ...
 *
 */
RAMFUNC_UART static inline void pac5xxx_uart_write2(PAC55XX_UART_TYPEDEF* uart_ptr, uint8_t data) { uart_ptr->THR.THR = data; }
 ...
 *
 */
RAMFUNC_UART static inline void pac5xxx_uart_int_enable_THREI2(PAC55XX_UART_TYPEDEF* uart_ptr, int enable) { uart_ptr->IER.THRIE = enable; }
 ...
 *
 */
RAMFUNC_UART static inline void pac5xxx_uart_int_enable_RDAI2(PAC55XX_UART_TYPEDEF* uart_ptr, int enable) { uart_ptr->IER.RBRIE = enable; }
 ...
 *
 */
RAMFUNC_UART static inline void pac5xxx_uart_fifo_enable2(PAC55XX_UART_TYPEDEF* uart_ptr, int enable) { uart_ptr->FCR.FIFOEN = enable; }
 ...
 *
 */
RAMFUNC_UART static inline void pac5xxx_uart_rx_fifo_reset2(PAC55XX_UART_TYPEDEF* uart_ptr) { uart_ptr->FCR.RXFIFORST = 1; }
 ...
 *
 */
RAMFUNC_UART static inline void pac5xxx_uart_rx_fifo_threshold2(PAC55XX_UART_TYPEDEF* uart_ptr, UARTFCR_FIFO_DEPTH_TYPE depth) { uart_ptr->FCR.RXTL = depth; }
 ...
 *
 */
RAMFUNC_UART static inline void pac5xxx_uart_tx_fifo_threshold2(PAC55XX_UART_TYPEDEF* uart_ptr, UARTFCR_FIFO_DEPTH_TYPE depth) { uart_ptr->FCR.TXTL = depth; }
