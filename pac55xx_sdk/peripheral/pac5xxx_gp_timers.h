...
typedef struct
{
    // GPTXCTL (GPTimer Control, Offset: 0x0000)        // GPTimerA @ 0x400B0000;   GPTimerB @ 0x400C0000
    union {
         __IO uint32_t w;
        struct {
    ...
    // GPTXCTR (GPTimer Counter, Offset: 0x0004)        // GPTimerA @ 0x400B0004;   GPTimerB @ 0x400C0004
    union{
        __IO uint32_t w;  
        struct{
                 uint32_t                   : 8;         // 0:7
