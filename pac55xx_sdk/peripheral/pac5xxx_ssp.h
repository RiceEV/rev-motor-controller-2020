...
typedef struct      //  SSPA @ 0x40020000, SSPB @ 0x40030000, SSPC @ 0x40040000, SSPD @ 0x40050000
{
    // CON (SSP Control Register, Offset: 0x0000);  SSPA @ 0x40020000, SSPB @ 0x40030000, SSPC @ 0x40040000, SSPD @ 0x40050000
    union {
        __IO uint32_t w;
        struct {
    ...
    // STAT (SSP Status Register, Offset: 0x0004);  SSPA @ 0x40020004, SSPB @ 0x40030004, SSPC @ 0x40040040, SSPD @ 0x40050004
    union {
        __I uint32_t w;
        struct {
    ...
    // DAT (SSP Data Register, Offset: 0x0008);  SSPA @ 0x40020008, SSPB @ 0x40030008, SSPC @ 0x40040008, SSPD @ 0x40050008
    union {
        __IO uint32_t w;
        struct {
    ...
    // CLK (SSP Clock Control Register, Offset: 0x000C);  SSPA @ 0x4002000C, SSPB @ 0x4003000C, SSPC @ 0x4004000C, SSPD @ 0x4005000C
    union {
        __IO uint32_t w;
        struct {
    ...
    // IMSC (SSP Interrupt Mask Set and Clear Register, Offset: 0x0010);  SSPA @ 0x40020010, SSPB @ 0x40030010, SSPC @ 0x40040010, SSPD @ 0x40050010
    union {
        __IO uint32_t w;
        struct {
    ...
    // RIS (SSP Raw Interrupt Status Register, Offset: 0x0014);  SSPA @ 0x40020014, SSPB @ 0x40030014, SSPC @ 0x40040014, SSPD @ 0x40050014
    union {
        __I uint32_t w;
        struct {
    ...
    // MIS (SSP Masked Interrupt Status Register, Offset: 0x0018);  SSPA @ 0x40020018, SSPB @ 0x40030018, SSPC @ 0x40040018, SSPD @ 0x40050018
    union {
        __I uint32_t w;
        struct {
    ...
    // ICLR (SSP Interrupt Clear Register, Offset: 0x001C);  SSPA @ 0x4002001C, SSPB @ 0x4003001C, SSPC @ 0x4004001C, SSPD @ 0x4005001C
    union {
        __IO uint32_t w;
        struct {
    ...
    // CSCR (SSP Slave Select Configuration Register, Offset: 0x0028);  SSPA @ 0x40020028, SSPB @ 0x40030028, SSPC @ 0x40040028, SSPD @ 0x40050028
    union {
        __IO uint32_t w;
        struct {
...
extern uint32_t ssp_read_one(SSP_TYPE SSP);
extern uint32_t ssp_available(SSP_TYPE ssp);
extern uint32_t check_ssp_rx(SSP_TYPE SSP);
extern void set_motor_params(SSP_TYPE ssp);
